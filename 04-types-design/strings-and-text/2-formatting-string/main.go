...
//     "Hello %s, you are %d years old" â† template with placeholders
//     fmt.Printf(template, "Rasel", 25) â†’ "Hello Rasel, you are 25 years old"
...
func main() {
	...
	fmt.Println("\n---------------------------------------------------")
	fmt.Println("ðŸš€ NEXT UP: ST.3 unicode & runes")
